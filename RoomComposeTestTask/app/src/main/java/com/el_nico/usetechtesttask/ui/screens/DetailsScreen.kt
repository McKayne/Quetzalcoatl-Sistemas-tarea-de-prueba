            ...
            Surface(
                ...
                Column(
                    ...
                    Surface(
                        ...
                        for (recent in recentObservationsState.value) {
                            val observations = listOf(
                                Pair("Ciudad:", recent.city),
                                Pair("Localidad:", recent.locationName),
                                Pair("Coordenadas:", "${recent.latitude} ${recent.longitude}"),
                                Pair("Nombre común:", recent.commonName),
                                Pair("Nombre cientifico:", recent.scientificName),
                                Pair("Cantidad de pájaros vistos:", recent.howMany.toString())
                            )
                    ...
                    Button(
                        ...
                        Text(text = if (favoritesState.value) "Borrar desde lista de favoritos"
                        else "Agregar a lista de favoritos")
                    }
